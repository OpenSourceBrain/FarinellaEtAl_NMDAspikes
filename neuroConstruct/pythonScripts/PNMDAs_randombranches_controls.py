#
#   A file that opens the neuroConstruct project FarinellaEtAl_NMDAspikes and run multiple simulations stimulating random terminal branches with variable number od synapses and variable rate/delay in order to determine the P(NMDAs)
#
