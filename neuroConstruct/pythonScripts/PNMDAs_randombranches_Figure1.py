#
#   File that run multiple instances of the FarinellaEtAl_NMDAspikes model, stimulating individual terminal branches with variable number of synapses, as in Fig.1 of FarinellaEtAl2014
#
#
