#
#   A file that opens the neuroConstruct project FarinellaEtAl_NMDAspikes and run multiple simulations stimulating ech terminal apical branch with varying number of synapses.
#
