#
#   File that run multiple instances of the FarinellaEtAl_NMDAspikes model, stimulating variable numbers of multiple terminal branches in variable temporal windows (example 100 ms), as in Fig.3 and 5C of FarinellaEtAl2014
#
