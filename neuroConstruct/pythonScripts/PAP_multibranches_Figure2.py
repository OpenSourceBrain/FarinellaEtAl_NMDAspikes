#
#   File that run multiple instances of the FarinellaEtAl_NMDAspikes model, stimulating variable numbers of multiple terminal branches, as in Fig. 2, 3 and 5C of FarinellaEtAl2014
#
...
projName = "FarinellaEtAl_NMDAspikes"
...
if numGenerated > 0:
    ...
    trials = 1 #set to required number of trials per configuration
    ...
    for y in range(2, Nbranches): #range of simultaneous stimulated branches to explore
       ...
       prefix = "b"+str(j) #number of simultaneous stimulated branches
