#
#   A file that opens the neuroConstruct project FarinellaEtAl_NMDAspikes and run multiple simulations with random distributed synchonous synaptic input and record from all the terminal branches
#
